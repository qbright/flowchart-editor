...
//
// a();
//# sourceMappingURL=initDrag.js.map
...
var ErrorType;
(function (ErrorType) {
    ErrorType["CONTAINER_NO_FIND"] = "container_no_find";
})(ErrorType || (ErrorType = {}));
var ErrorHandler = /** @class */ (function () {
    function ErrorHandler() {
    }
    ErrorHandler.throwError = function (errMsg) {
...
var getId = function (prefix) {
    if (prefix === void 0) { prefix = "ychart"; }
...
var BaseChart = /** @class */ (function () {
    function BaseChart(name, option) {
        this.name = name;
    ...
    BaseChart.prototype.initDragEvent = function () {
        var _this = this;
        this.group.call(drag().on("start", function () {
        }).on("drag", function () {
            _this.group.attr("transform", "translate(" + event.x + "," + event.y + ")");
        }).on("end", function () {
        }));
    };
    BaseChart.prototype.generalGroup = function () {
...
var Start = /** @class */ (function (_super) {
    ...
    function Start(option) {
        var _this = _super.call(this, Start._name, option) || this;
        _this.initDragEvent();
        return _this;
    }
    Start.prototype.drawChart = function () {
        var arcD = arc()
            .innerRadius(0)
            .outerRadius(30);
        var d = arcD({
...
var FlowType;
(function (FlowType) {
    FlowType[FlowType["START"] = 0] = "START";
    FlowType[FlowType["PROCESS"] = 1] = "PROCESS";
    FlowType[FlowType["FORK"] = 2] = "FORK";
    FlowType[FlowType["JOIN"] = 3] = "JOIN";
    FlowType[FlowType["END"] = 4] = "END";
    FlowType[FlowType["PATH"] = 5] = "PATH";
})(FlowType || (FlowType = {}));
var FlowType$1 = FlowType;
...
var Defs = /** @class */ (function () {
    ...
    Defs.prototype.initDefs = function () {
        var _this = this;
        this.defs = this.svg.append("defs");
        Defs.markerSet.forEach(function (item) {
            var marker = _this.defs.append("marker");
            for (var key in Defs.markerConfig) {
...
var Process = /** @class */ (function (_super) {
    ...
    function Process(option) {
        return _super.call(this, Process._name, option) || this;
    }
    Process.prototype.drawChart = function () {
        var left = -Process.style.width / 2;
        var top = -Process.style.height / 2;
        var right = left + Process.style.width;
        var bottom = top + Process.style.height;
        this.group.append("path")
    ...
    Process.prototype.getPath = function (left, top, right, bottom, radius) {
        if (radius === void 0) { radius = 0; }
        var left1 = left + radius;
        var right1 = right - radius;
        var top1 = top + radius;
        var bottom1 = bottom - radius;
...
var DiamondDrawer = /** @class */ (function () {
    function DiamondDrawer() {
    }
    DiamondDrawer.generalPath = function (width, height) {
        var left = -width / 2;
        var top = -height / 2;
...
//# sourceMappingURL=diamondDrawer.js.map

var Fork = /** @class */ (function (_super) {
    __extends(Fork, _super);
    function Fork(option) {
        return _super.call(this, Fork._name, option) || this;
    }
    Fork.prototype.drawChart = function () {
        this.group.append("path")
...
var Join = /** @class */ (function (_super) {
    ...
    function Join(option) {
        return _super.call(this, Join._name, option) || this;
    }
    Join.prototype.drawChart = function () {
        this.group.append("path")
...
var Core$1 = /** @class */ (function () {
    function Core(containerSelector, config) {
        this.cWidth = 800;
        this.cHeight = 600;
        this.flowSet = [];
    ...
    Core.prototype.initContainer = function (selector) {
        var container = select(selector);
        if (!container.size()) {
            ErrorHandler.throwError(ErrorType.CONTAINER_NO_FIND);
        }
        this.container = container;
        var _a = this.container.node().getBoundingClientRect(), width = _a.width, height = _a.height;
    ...
    Core.prototype.insertFlow = function (type, option) {
        if (option === void 0) { option = {}; }
        var chart;
        var defopt = {
            parent: this.svg
        };
        var opt = Object.assign(option, defopt);
        switch (type) {
            case FlowType$1.START:
                chart = new Start(opt);
                break;
            case FlowType$1.PROCESS:
                chart = new Process(opt);
                break;
            case FlowType$1.FORK:
                chart = new Fork(opt);
                break;
            case FlowType$1.JOIN:
                chart = new Join(opt);
                break;
        }
        if (chart) {
...
var chart = new Core$1("#container", {});
chart.insertFlow(FlowType$1.START);
chart.insertFlow(FlowType$1.PROCESS);
chart.insertFlow(FlowType$1.FORK);
chart.insertFlow(FlowType$1.JOIN);
